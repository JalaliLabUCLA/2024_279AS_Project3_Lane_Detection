...
def parse_args():
    ...
    parser.add_argument('--logDir',
                        ...
                        type=str,
                        default='runs/')
    parser.add_argument('--weights', type=str, default='G:/UCLA/Lane Detection Project/Lane Detection/Weights/YOLOP/analog_batchsize16/epoch-189.pth', help='model.pth path(s)')
