...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, transform=None,valid=False):
        ...
        self.valid=valid
        if valid:
            self.root='G:/UCLA/Lane Detection Project/Lane Detection/bdd100k_preprocessed_digital/images/val'
    ...
    def __getitem__(self, idx):
        ...
        label1 = cv2.imread(image_name.replace("G:/UCLA/Lane Detection Project/Lane Detection/bdd100k_preprocessed_digital/images","G:/UCLA/Lane Detection Project/Lane Detection/bdd100k_label/da_seg_annotations/bdd_seg_gt").replace("jpg","png"), 0)
        label2 = cv2.imread(image_name.replace("G:/UCLA/Lane Detection Project/Lane Detection/bdd100k_preprocessed_digital/images","G:/UCLA/Lane Detection Project/Lane Detection/bdd100k_label/ll_seg_annotations/bdd_lane_gt").replace("jpg","png"), 0)
        if not self.valid:
